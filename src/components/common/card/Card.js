...
function Card({ datetime, title, imageUrl, subTitle, description, starScore, starCount, commentCount, likeCount }) {
    return (
        <div className="card">
            ...
            <LikeCommentCount commentCount={commentCount} likeCount={likeCount} isLike />
        </div>
    );
}
